...
export const createMulticolorSvg = (svgFiguresResult, statesJson, colorScheme) => {
    const id = "a";
    const viewsAndUses = createViewsUses(statesJson, svgFiguresResult, colorScheme, id);
    if (!viewsAndUses)
        return undefined;
...
const createViewsUses = (statesJson, svgFiguresResult, colorScheme, id) => {
    ...
    enabledStyle = usedColors
        ...
        let colorValue = colorScheme === "light"
