 ...
 */
export function readyToProcess(SRC_DIRECTORY, OUTPUT_DIRECTORY, STATES_FILENAME, LOG_PATH, numberOfArgsProvided) {
    ...
    const validateSchemaResult = validateStatesSchema(statesResult.statesObject);
