...
import { CopyCodeComponent } from "../copy-code/copy-code.ng";
...
import { CommonSnippetsComponent } from "../common-snippets/common-snippets.ng";

const DEFAULT_TEMPLATE_LANGUAGE = "html";

@Component({
  selector: "code-snippet",
  templateUrl: "./code-snippet.ng.html",
