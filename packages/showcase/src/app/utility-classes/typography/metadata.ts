...
export const typographyMetadata = {
  ...
  codeSnippets: {
    ...
    textBodyRegularLarge: {
      ...
      template: [
        { tag: "p", class: "text-body-regular-l", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyRegularMedium: {
      ...
      template: [
        { tag: "p", class: "text-body-regular-m", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyRegularSmall: {
      ...
      template: [
        { tag: "p", class: "text-body-regular-s", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyRegularExtraSmall: {
      ...
      template: [
        { tag: "p", class: "text-body-highlighted-xs", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyHighlightedLarge: {
      ...
      template: [
        { tag: "p", class: "text-body-highlighted-l", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyHighlightedMedium: {
      ...
      template: [
        { tag: "p", class: "text-body-highlighted-m", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyHighlightedSmall: {
      ...
      template: [
        { tag: "p", class: "text-body-highlighted-s", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyItalicLarge: {
      ...
      template: [
        { tag: "p", class: "text-body-italic-l", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyItalicMedium: {
      ...
      template: [
        { tag: "p", class: "text-body-italic-m", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyItalicSmall: {
      ...
      template: [
        { tag: "p", class: "text-body-italic-s", children: CONTENT_HERE }
      ]
    },
    ...
    textBodyItalicExtraSmall: {
      ...
      template: [
        { tag: "p", class: "text-body-italic-xs", children: CONTENT_HERE }
      ]
    }
  }
