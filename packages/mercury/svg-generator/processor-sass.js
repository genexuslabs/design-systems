...
function monochromeStyles(iconsList) {
  ...
  // ${icon}.svg`;
    ...
    states.forEach(state => {
      list += `
  &-${icon}--${state}-light {
    --icon-path :url("#{$icons-path}${category}/light/${icon}.svg#${state}");
  }
  &-${icon}--${state}-dark {
    --icon-path :url("#{$icons-path}${category}/dark/${icon}.svg#${state}");
  }
      `;
    });
  });
...
function multicolorStyles(iconsList) {
  ...
  // ${icon}.svg
  &-${icon}--enabled-light {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/light/${icon}.svg#enabled");
  }
  &-${icon}--enabled-dark {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/dark/${icon}.svg#enabled");
  }

  &-${icon}--hover-light {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/light/${icon}.svg#hover");
  }
  &-${icon}--hover-dark {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/dark/${icon}.svg#hover");
  }

  &-${icon}--active-light {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/light/${icon}.svg#active");
  }
  &-${icon}--active-dark {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/dark/${icon}.svg#active");
  }

  &-${icon}--disabled-light {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/light/${icon}.svg#disabled");
  }
  &-${icon}--disabled-dark {
    --icon-path: url("#{$icons-path}${iconsList.categoryName}/dark/${icon}.svg#disabled");
  }
    `;
  });
  output += `
